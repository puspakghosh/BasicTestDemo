...
public class BenefitsFragment extends Fragment implements BenefitsContract.View {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = root.findViewById(R.id.recycler_view_benefits);
        progressBar = root.findViewById(R.id.progress_bar_benefits);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        presenter = new BenefitsPresenter(this);
        presenter.fetchData();
