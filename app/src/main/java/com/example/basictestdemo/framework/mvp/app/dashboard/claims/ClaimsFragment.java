...
public class ClaimsFragment extends Fragment implements ClaimsContract.View {

    private ClaimsPresenter presenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_claim, container, false);

        recyclerView = root.findViewById(R.id.recycler_view_claims);
        progressBar = root.findViewById(R.id.progress_bar_claims);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        presenter = new ClaimsPresenter(this);
        presenter.fetchData();
